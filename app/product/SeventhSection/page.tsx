    ...
    <div>
      <section className="flex flex-col py-20 items-center justify-center bg-[#28282B]">
        <div className="text-center flex flex-col items-center justify-center pb-20">
          <Image
            src="/images/orzana-logo2.png"
            alt="company logo"
            width={100}
            height={100}
            className="w-60 h-100 mx-auto mb-10"
          />
          ...
          <div className="text-xl bg-white hover:bg-green-300 hover:cursor-pointer p-6 rounded-lg w-40 items-center justify-center flex">
            Get started
          </div>
        </div>
        ...
        <div className="hidden md:flex pt-40 space-x-40 border-t  ">
          <div className="">
            <Image
              src="/images/orzana-footer-logo3.png"
          ...
          <div className=" flex-col space-y-6 flex">
            <div className="text-xl text-gray-200 pb-10">Orzana</div>
